"""Deblur architecture from DeblurGAN-v2 paper.

copied from https://github.com/VITA-Group/DeblurGANv2/blob/master/models/fpn_inception.py
weights can be downloaded from https://drive.google.com/uc?export=view&id=1UXcsRVW-6KF23_TNzxw-xC0SzaMfXOaR
"""
...
class FPN(nn.Module):
    def __init__(self, norm_layer, num_filters=256):
        """Create an `FPN` instance for feature extraction.
        ...
        """
        super().__init__()
        self.inception = inceptionresnetv2(num_classes=1000, pretrained=False)
