...
| Attack            | Config name                                                                                    | Description                                                                                                                                         |
|-------------------|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Editing           | signinversion, resampling, requantization, scaling, noise, pinknoise, filter, echo, mpeg, aac, boost, wienerfilter                     | Common distortions that may be used while basic sound editing                                                                                       |
