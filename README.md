...
| Attack             | Config name                                                                                    | Description                                                                                                                                         |
|--------------------|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Signal distortions | signinversion, resampling, requantization, gain, filter, whitenoise, pinknoise                 | Common signal-level transformations affecting amplitude, sampling, quantization, frequency content, or noise.                                       |
