...
| Attack             | Config name                                                                                    | Description                                                                                                                                         |
|--------------------|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Signal distortions | signinversion, resampling, requantization, scaling, filter, whitenoise, pinknoise, boost       | Common signal-level transformations affecting amplitude, sampling, quantization, frequency content, or noise.                                       |
| Compression        | mpeg, aac                                                                                      | Lossy audio compression and encoding distortions.                                                                                                   |
| Acoustic           | echo                                                                                           | Acoustic effects simulating propagation and reflections of sound.                                                                                   |
| Effect             | pitch                                                                                          | Different audio effects.                                                                                                                            |
