...
.. |number_of_audio_algorithms| replace:: 17
.. |number_of_image_attacks| replace:: 30+
.. |number_of_audio_attacks| replace:: 17
...
* :ref:`Datasets <datasets-link>`: `DiffusionDB`_, `MS COCO`_, `LibriSpeech`_, `AudioSet`_ supported
